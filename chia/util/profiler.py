...
# the output will be printed to your gold root path, e.g. ~/.gold/mainnet/profile/
# to analyze the profile, run:

#   python chia/utils/profiler.py ~/.chia/mainnet/profile | less -r

# this will print CPU usage of the gold full node main thread at 1 second increments.
